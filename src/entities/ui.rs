...
/// Marker component for the Kaphrao pan step indicator
/// Shows the next ingredient for the Kaphrao (Thai Kaphrao Pork) cooking sequence
#[derive(Component)]
pub struct StepIndicatorKaphrao;
