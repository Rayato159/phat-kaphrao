...
pub struct GameState {
    pub hp: u8,
    pub max_hp: u8,
    pub ingredient_kaphrao_dropped: bool,
    pub ingredient_egg_dropped: bool,
    // pub current_step: usize,
    pub steps_completed: usize,
    pub kaphrao_has_oil: bool,
    ...
    pub kaphrao_has_gauge: bool,
    pub egg_has_guage: bool,
    pub target_width: f32,
    pub target_egg_x: Option<f32>,
    pub target_kaphrao_x: Option<f32>,
    pub count_phat_kaphrao: f32,
    pub count_tod_kai: f32,
    pub kaphrao_is_finished: bool,
...
impl Default for GameState {
    fn default() -> Self {
        Self {
            hp: 5,
            max_hp: 5,
            ingredient_kaphrao_dropped: true,
            ingredient_egg_dropped: true,
            steps_completed: 0,
            kaphrao_has_oil: false,
            egg_has_oil: false,
            gauge_container: false,
            gauge_container_entity: None,
            gauge_container_width: 600.0,
            gauge_container_height: 40.0,
            kaphrao_has_gauge: false,
            egg_has_guage: false,
            target_width: 0.10,
            target_egg_x: None,
            target_kaphrao_x: None,
            count_phat_kaphrao: 0.0,
            count_tod_kai: 0.0,
            kaphrao_is_finished: false,
